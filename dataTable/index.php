...
<body>
    ...
    success: function(response) {
        ...
        var fileName = responseParts[0];
        var lsequence = responseParts.slice(1).join(',');
        console.log("Filename: " + fileName);
        console.log("Sequence: " + lsequence);
        lastFilename = encodeURIComponent(fileName); 
        $('textarea[name="sequence"]').val(lsequence);
    }
});
